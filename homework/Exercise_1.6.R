...
genome_coverage <- scan("genome_coverage_30.txt")
...
hist(genome_coverage, breaks = 50, probability = TRUE, 
     main = "Coverage Distribution Plot for Coverage of 30X",
...
# Overlay Normal distribution data with mean = 30 and std. dev. = 5.47
mean_value <- 30
std_dev <- 5.47
